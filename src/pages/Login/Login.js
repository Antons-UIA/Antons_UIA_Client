...
const Login=()=>{
  ...
  const API_URL =
  "https://uia-server-6n2165efb-atharvakinikar.vercel.app/api/auth/login";
        ...
        <div className="w-2/5">
          ...
          <div className="flex flex-col justify-start bg-blue-100 rounded-xl mt-4 p-5">
            ...
            <div className="mt-5 m-auto flex flex-col justify-items-center ">
              <button className="w-full bg-[#1678F2] w-full self-center py-2 rounded-xl font-semibold text-md my-1 text-slate-100 px-10 py-2" onClick={handlePatientSubmit}>
                Login as a Patient
              </button>
